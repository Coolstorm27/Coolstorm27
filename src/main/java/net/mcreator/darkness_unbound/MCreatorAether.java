...
public class MCreatorAether extends Elementsdarkness_unbound.ModElement {
	@ObjectHolder("darkness_unbound:aether")
	public static final ModDimension dimension = null;
	@ObjectHolder("darkness_unbound:aether")
	public static final Item block = null;
	@ObjectHolder("darkness_unbound:aether_portal")
	public static final CustomPortalBlock portal = null;
	public static DimensionType type = null;
	private static Biome[] dimensionBiomes;

	public MCreatorAether(Elementsdarkness_unbound instance) {
		super(instance, 25);
	...
	public void onRegisterDimensionsEvent(RegisterDimensionsEvent event) {
		if (DimensionType.byName(new ResourceLocation("darkness_unbound:aether")) == null) {
			DimensionManager.registerDimension(new ResourceLocation("darkness_unbound:aether"), dimension, null, true);
		}
		type = DimensionType.byName(new ResourceLocation("darkness_unbound:aether"));
	}

	@Override
	public void init(FMLCommonSetupEvent event) {
		dimensionBiomes = new Biome[]{ForgeRegistries.BIOMES.getValue(new ResourceLocation("darkness_unbound:aethernormal")),};
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new CustomPortalBlock());
		elements.items.add(() -> new ModTrigger().setRegistryName("aether"));
	}
				...
				for (int j7 = -1; j7 <= 1; ++j7) {
					for (int i8 = 1; i8 < 3; ++i8) {
						for (int i9 = -1; i9 < 3; ++i9) {
							...
							this.world.setBlockState(blockpos$mutableblockpos, flag
			...
			for (int k7 = -1; k7 < 3; ++k7) {
				for (int j8 = -1; j8 < 4; ++j8) {
					if (k7 == -1 || k7 == 2 || j8 == -1 || j8 == 3) {
						...
						this.world.setBlockState(blockpos$mutableblockpos, Blocks.GLOWSTONE.getDefaultState().getBlock().getDefaultState(), 3);
					}
				}
			}
		...
		if (event.getTo() == type) {
			{
				...
				MCreatorAetherPlayerEntersDimension.executeProcedure($_dependencies);
			}
		}
	}
		...
		public ChunkProviderModded(IWorld world, BiomeProvider provider) {
			super(world, provider, new EndGenerationSettings() {
				public BlockState getDefaultBlock() {
					return MCreatorAetherstone.block.getDefaultState();
				}
