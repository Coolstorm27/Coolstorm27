...
public class MCreatorAetherlog extends Elementsdarkness_unbound.ModElement {
	@ObjectHolder("darkness_unbound:aetherlog")
	public static final Block block = null;

	public MCreatorAetherlog(Elementsdarkness_unbound instance) {
		super(instance, 28);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			super(Block.Properties.create(Material.WOOD).sound(SoundType.WOOD).hardnessAndResistance(1.3f, 10f).lightValue(0).harvestLevel(-1)
					.harvestTool(ToolType.AXE));
			this.setDefaultState(this.stateContainer.getBaseState().with(FACING, Direction.SOUTH));
			setRegistryName("aetherlog");
		}
